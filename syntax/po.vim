...
syn keyword   poCommentTodo NOTE TODO FIXME XXX TBD contained
syn match     poComment "^#.*$" contains=@Spell,poCommentTodo
syn keyword   poFlagFuzzy fuzzy contained
syn match     poCommentTranslator "^# .*$" contains=poCopyrightUnset,poCommentTodo,@Spell
...
hi def link poCommentTodo       Todo
