...
syn keyword pythonTodo		FIXME NOTE NOTES TODO XXX GOOD BAD WTF contained
...
syn region  pythonRawString
      \ start=+[uUbB]\=[rR]\z(['"]\)+ end="\z1" skip="\\\\\|\\\z1"
syn region  pythonRawString
      \ start=+[uUbB]\=[rR]\z('''\|"""\)+ end="\z1" keepend
...
if !exists("python_no_builtin_highlight")
  ...
  " Not really builtins, but commonly used.
  syn keyword pythonBuiltin	self cls
  syn keyword pythonBuiltin	__file__ __name__ __author__ __version__
  " itertools
  syn keyword pythonBuiltin	chain
endif
...
" Start syntax folding additions.
